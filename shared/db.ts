...
export type VenueTranslation = typeof tables.venueTranslations.$inferSelect
export type EventSession = typeof tables.eventSessions.$inferSelect
export type SessionSectionPrice = typeof tables.sessionSectionPrices.$inferSelect
export type SessionSeatOverride = typeof tables.sessionSeatOverrides.$inferSelect
export type SeatHoldItem = typeof tables.seatHoldItems.$inferSelect
...
export type EventTranslation = typeof tables.eventTranslations.$inferSelect
...
export type TicketTypeTranslation = typeof tables.ticketTypeTranslations.$inferSelect
